...
// tipo Trigger del schema; por ahora está a mano con 3 bindings
// para validar el esqueleto de orquestación.
type KeyMap struct {
...
func (k KeyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.NextPanel, k.PrevPanel, k.Quit}
}
